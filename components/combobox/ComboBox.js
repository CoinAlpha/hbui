...
const spanStyles = {}
spanStyles[true] = tw`block truncate font-medium px-4 pl-10 py-2 hover:bg-tertiary dark:hover:bg-quaternary hover:cursor-pointer`
spanStyles[false] = tw`block truncate font-normal px-4 pl-10 py-2 hover:bg-tertiary dark:hover:bg-quaternary hover:cursor-pointer`
const spanBStyles = {}
